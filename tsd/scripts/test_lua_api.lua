...
test("tsd.float3(v) uniform", function()
  local v = tsd.float3(5.0)
  assert(v ~= nil, "float3 should be created")
  assert(v.x == 5.0, "v.x should be 5.0")
  assert(v.y == 5.0, "v.y should be 5.0")
  assert(v.z == 5.0, "v.z should be 5.0")
end)
...
test("tsd.float4(float3, w)", function()
  local v3 = tsd.float3(1.0, 2.0, 3.0)
  local v4 = tsd.float4(v3, 4.0)
  assert(v4 ~= nil, "float4 should be created from float3")
end)
