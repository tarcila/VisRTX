...
---@param y number
---@return tsd.float2
function tsd.float2(x, y) end

--- Construct a float3.
---@overload fun(x: number, y: number, z: number): tsd.float3
---@overload fun(v: number): tsd.float3
---@return tsd.float3
function tsd.float3(...) end

--- Construct a float4.
---@overload fun(x: number, y: number, z: number, w: number): tsd.float4
---@overload fun(v: tsd.float3, w: number): tsd.float4
---@overload fun(v: number): tsd.float4
---@return tsd.float4
function tsd.float4(...) end

--- Construct a mat3 (packed SRT: columns = scale, euler-rotation-degrees, translation).
---@param col0 tsd.float3
---@param col1 tsd.float3
---@param col2 tsd.float3
---@return tsd.mat3
function tsd.mat3(col0, col1, col2) end
...
------------------------------------------------------------------------
-- Camera state (shared by viewer and render)
------------------------------------------------------------------------

---@class tsd.CameraState
---@field at? tsd.float3 Look-at target.
---@field distance? number Distance from the target.
---@field azel? tsd.float2 Azimuth and elevation in degrees.
---@field up? integer Up axis (0=POS_X, 1=POS_Y, 2=POS_Z, 3=NEG_X, 4=NEG_Y, 5=NEG_Z).
